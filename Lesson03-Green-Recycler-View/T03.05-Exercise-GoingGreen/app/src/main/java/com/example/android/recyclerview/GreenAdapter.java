...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.viewHolderIndexTextView.setText(String.format("ViewHolder index: %s", viewHolderCount));
        ...
        Log.i(TAG, "viewHolderCount = " + String.valueOf(viewHolderCount));
        viewHolderCount++;
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView viewHolderIndexTextView;
        ...
        public NumberViewHolder(View itemView) {
            ...
            viewHolderIndexTextView = (TextView) itemView.findViewById(R.id.tv_view_holder_instance);
        }
